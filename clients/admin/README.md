# Villsource BuzMag — Admin

Operator console for the Villsource BuzMag .NET Starter Kit. Built with React 19, Vite 7, TypeScript, TanStack Query, React Router and Tailwind 4 + shadcn/ui.
...
- Node.js 20+
- The API running locally (`dotnet run --project src/Host/Villsource.BuzMag.Api`, defaults to `http://localhost:5030`)
