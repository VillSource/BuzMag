# Villsource BuzMag — Dashboard

Tenant-facing dashboard for the Villsource BuzMag .NET Starter Kit. Shows realtime telemetry over Server-Sent Events, current-period usage vs. plan limits (Recharts), and billing history.
