...
const OrganizationUnitDetailPage = lazyNamed(
    () => import("@/pages/organizations/organization-unit-detail"),
        ...
        children: [
            {
                ...
                children: [
                    ...
                    {path: "organizations/units/:unitId", element: withSuspense(<OrganizationUnitDetailPage/>)},
