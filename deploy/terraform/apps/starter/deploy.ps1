...
if ($BuildApi) {
  ...
  dotnet publish "$RepoRoot/src/Host/Villsource.BuzMag.Api/Villsource.BuzMag.Api.csproj" `
  ...
  dotnet publish "$RepoRoot/src/Host/Villsource.BuzMag.DbMigrator/Villsource.BuzMag.DbMigrator.csproj" `
    -c Release -r linux-x64 `
    /t:PublishContainer `
    -p:ContainerRegistry="$registryHost" `
