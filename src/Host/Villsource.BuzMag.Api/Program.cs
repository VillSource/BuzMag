...
builder.Services.AddMediator(o =>
{
    ...
    o.Assemblies = [
        ...
        typeof(Villsource.Modules.Oidc.Contracts.OidcContractsMarker),
        typeof(Villsource.Modules.Oidc.OidcModule),
    ];
});
...
var moduleAssemblies = new Assembly[]
{
    ...
    typeof(Villsource.Modules.Oidc.OidcModule).Assembly,
};
...
builder.Services.AddHostedService<Villsource.BuzMag.Api.OrphanedOutboxRecurringJobCleanupService>();

// Demo data is provisioned by the DbMigrator's `seed-demo` verb, not the API — the API never mutates data on startup.
// See src/Host/Villsource.BuzMag.DbMigrator/README.md.
