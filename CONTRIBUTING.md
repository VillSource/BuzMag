...
```bash
dotnet build src/Villsource.BuzMag.slnx
dotnet run --project src/Host/Villsource.BuzMag.AppHost   # full Aspire stack
dotnet test src/Villsource.BuzMag.slnx                    # tests (integration suite needs Docker)
```
